...
class TestParallel(unittest.TestCase):
    def test_multipush(self):
        ...
        start_workers, kill_workers = testing_lib.construct_worker_pool(config.num_local_workers(), config.WORKER_ADDRESSES, send_jobs, on_recv_result, num_pushers=config.NUM_PUSHERS)
        start_workers()
